...
public class OdontologoController {
    ...
    @Operation(summary = "Crear nuevo odontologo")
    ...
    @Operation(summary = "Obtener lista de todos los odontologos")
    ...
    @Operation(summary = "Buscar Odontolgo por Id")
    ...
    @Operation(summary = "Actualizar Odontologo por id")
    ...
    @Operation(summary = "Obtener Odontolog por Id")
